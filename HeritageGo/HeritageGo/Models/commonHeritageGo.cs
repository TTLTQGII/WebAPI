...
{
    public class commonHeritageGo
    {
        public static int _itemsofpage = 10;
        private static List<Kieudulieu> _kieu = new List<Kieudulieu>(new Kieudulieu[]{
                                new Kieudulieu(){ key= "text", value ="Kiểu ký tự"},
